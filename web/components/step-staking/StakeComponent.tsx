    ...
    <>
      <div className="flex justify-between items-center text-sm">
        ...
        <div className='flex gap-2 items-center'>
          ...
          <button className='text-xs p-1 transition-color duration-300 hover:text-black hover:bg-[#06d6a0] text-[#06d6a0] bg-[#003628] rounded-md uppercase' onClick={() => onInputUpdate(parseInput(stepUiBalance / 2, 'step'))}>Half</button>
          <button className='text-xs p-1 transition-color duration-300 hover:text-black hover:bg-[#06d6a0] text-[#06d6a0] bg-[#003628] rounded-md uppercase' onClick={() => onInputUpdate(parseInput(stepUiBalance, 'step'))}>Max</button>
        </div>
      </div>
